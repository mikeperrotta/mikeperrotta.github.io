...
export const EMPIRE_APP_EXTERNAL_LINK = 'https://apps.apple.com/us/app/empire-party-game/id1494647723'
...
export const SHOE_RACK = `${PROJECTS_ROOT}/shoerack`;
export const SPICE_RACK = `${PROJECTS_ROOT}/spicerack`;
